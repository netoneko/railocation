...
@@Pionerskaya_bus = {:name => 'Пионерская', :city => 'Yekaterinburg', :routes => ['05а', '034', '046', '048', '052', '056', '082', 'тб 12', 'тб 18'], :coords => '56.859654,60.619517', :type => 'bus', :long_id => 1}

@@Pionerskaya_tram = {:name => 'Пионерская', :city => 'Yekaterinburg', :routes => ['2', '5', '7', '8', '14', '16', '20', '22', '23', '25', '26', '32', 'А'], :coords => '56.85915,60.621282', :type => 'tram', :long_id => 2}

@@route_23 = {'Каменные палатки' => '56.8414849,60.6789118', 'Профессорская' => '56.8403083,60.6530178', 'Гагарина' => '56.8401616,60.646956', 'Первомайская' => '56.841793,60.6328194', 'Блюхера' => '56.8514331,60.6410712', 'Советская' => '56.8541522,60.6367475', #'Пионеров' => '56.8910648,60.5916166', 
